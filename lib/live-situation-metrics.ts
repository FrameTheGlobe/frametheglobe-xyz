...
export const LIVE_SITUATION_METRICS: LiveSituationMetric[] = [
  {
    ...
    sinceLabel:
      'Since the applicable post-ceasefire reporting window (definition varies — confirm at source)',
    valueDisplay: null,
    valueQualifier: undefined,
    basis: 'humanitarian_flash',
    asOf: '2026-04-09',
    sourceName: 'UN OCHA oPt',
    sourceUrl: 'https://www.ochaopt.org/',
    caveat:
      'Replace valueDisplay with the exact figure + date from a specific OCHA / cluster flash update you cite. Totals often lag and may exclude pending verification.',
  },
  {
    ...
    metricLabel: 'Fatalities reported',
    sinceLabel:
      'Since the applicable ceasefire monitoring window (confirm denominator at source)',
    valueDisplay: null,
    basis: 'un_consolidated',
    asOf: '2026-04-09',
    sourceName: 'ReliefWeb — Lebanon',
    sourceUrl: 'https://reliefweb.int/country/lbn',
    caveat:
      'Point sourceUrl to a specific ReliefWeb or UN flash update you use. Official and civil-society tallies may diverge — one cited row per publish.',
  },
  {
    ...
    metricLabel: 'Fatalities reported',
    sinceLabel:
      'Since the reporting window stated in your chosen source (often calendar month)',
    valueDisplay: null,
    basis: 'humanitarian_flash',
    asOf: '2026-04-09',
